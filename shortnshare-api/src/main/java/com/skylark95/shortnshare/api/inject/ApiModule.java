...
public abstract class ApiModule extends AbstractModule {
    ...
    protected void configure() {
        bind(Api.class).to(shortnshareApi());
        bind(UrlShortener.class).to(urlShorener());
        doConfigure();
    }

    protected abstract void doConfigure();
    protected abstract Class<? extends UrlShortener> urlShorener();
    protected abstract Class<? extends Api> shortnshareApi();
